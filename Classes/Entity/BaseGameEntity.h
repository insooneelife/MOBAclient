...
public:
	...
	static const bm_entity_type entity_type_num_map;
	...
	const cocos2d::Vec2&			getMargin() const;
	void							setMargin(const cocos2d::Vec2& val);
...
protected:
	...
	//entity margin for difference between real pos and render pos
	cocos2d::Vec2	_margin;
